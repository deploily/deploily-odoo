...
class TestFlutterwaveController(FlutterwaveController):
    ...
    def test_flutterwave_return_from_authorization(self, response):
        """Process the response sent by Flutterwave after authorization.

        :param str response: The stringified JSON response.
        """
        res = self.flutterwave_return_from_authorization(self, response)
    ...
    def test_flutterwave_webhook(self):
        ...
        :rtype: str
        """
        res = self.flutterwave_webhook(self)
